...
const Schema = z.object({
  ...
  advancedTaxEnabled: z.boolean(),
  gratuityFourYears240Days: z.boolean(),
...
export async function updatePayrollSettings(
  ...
  const parsed = Schema.safeParse({
    ...
    advancedTaxEnabled: fd.get("advancedTaxEnabled") !== null,
    gratuityFourYears240Days: fd.get("gratuityFourYears240Days") !== null,
